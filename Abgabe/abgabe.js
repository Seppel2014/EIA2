...
(function (Abgabe) {
    ...
    function play() {
        ...
        renderBall(); //renders the ball
        drawPlayer(); //calls move Player to draw and move Players which then calls playerballcollision and installs eventlistener for mouse
    ...
    class npc {
        ...
        precision;
        color;
        type; //1 and 2 are players, 3 is linejudge, 4
        active;
        id;
        drawsize;
        checksize;
    ...
    function updateStats() {
        ...
        newprecision = ((Math.random() * (playerprecisionmin.valueAsNumber - playerprecisionmin.valueAsNumber)) + playerprecisionmin.valueAsNumber) / 100;
        console.log(playerprecisionmin.value);
        console.log(playerprecisionmax.valueAsNumber);

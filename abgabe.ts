namespace Abgabe {
    ...
    var goalcounter1: HTMLElement = document.getElementById("goalcounter1");
    var goalcounter2: HTMLElement = document.getElementById("goalcounter2");
    var ballownership: HTMLElement = document.getElementById("ballownership");

    var exchangeplayerteam1: HTMLElement = document.getElementById("exchangeplayerteam1");
    var exchangeplayerteam2: HTMLElement = document.getElementById("exchangeplayerteam2");
    ...
    function newNpcs() {
        for (let i: number = 0; npcs.length < 26; i++) {
            ...
            let size: number = randomNumber(10, 12);
    ...
    function exchangeplayer(i: number) {
